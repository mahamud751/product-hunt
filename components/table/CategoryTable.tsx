...
import { Category, Status } from "@/services/types";
...
const CategoryTable: React.FC<CategoryTableClientProps> = ({
  categories,
  totalCategories,
  initialPage,
  initialRowsPerPage,
  ...
  const [filteredTotalCategory, setFilteredTotalCategory] =
    useState(totalCategories);
            ...
            {tabValue === 0 && (
              <Box>
                ...
                <CategoryStatusUpdater
                  ...
                  status={activeCategory?.status ?? Status.PENDING}
                />
              </Box>
            )}
          </Box>
