...
import { updateCategoryStatus } from "@/lib/server-actions";

interface CategoryStatusUpdaterProps {
  categoryId: string;
  status: Status;
}

const CategoryStatusUpdater: React.FC<CategoryStatusUpdaterProps> = ({
  categoryId,
  status,
}) => {
  ...
  const handleUpdateStatus = async () => {
    ...
    try {
      await updateCategoryStatus(categoryId, selectedStatus);
...
export default CategoryStatusUpdater;
