...
import { Search, Filter, MoreVertical, Download, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
...
export default function Subscriptions({ dateFilter }: { dateFilter: string }) {
  ...
  const [sortBy, setSortBy] = useState<'tenantName' | 'price' | 'updatedAt'>('updatedAt');
          ...
          <thead className="bg-gray-50">
            <tr>
              <th scope="col" className="px-6 py-3 text-left">
                <input
                  type="checkbox"
                  checked={selectedSubscriptions.length === mockSubscriptions.length}
