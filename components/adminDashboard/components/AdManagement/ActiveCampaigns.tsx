...
import { Search, Filter, MoreVertical, Download, Pause, Star, Edit3, Trash2 } from 'lucide-react';
...
export default function ActiveCampaigns({ dateFilter }: { dateFilter: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold text-[#1F1F1F]">Active Campaigns</h2>
