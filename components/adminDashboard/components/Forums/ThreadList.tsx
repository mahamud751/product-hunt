...
const mockThreads: Thread[] = [
  {
    ...
    content:
      "Looking for advice on launching a new SaaS product. What are the key things to consider?",
  ...
  },
  {
    ...
    content:
      "Share your experiences and strategies for social media marketing.",
    category: "Marketing",
    status: "Pending",
    isPinned: false,
    replies: 38,
  ...
  },
  {
    ...
    content:
      "What are the essential elements for fostering an engaged developer community?",
    category: "Community",
    status: "Locked",
    isPinned: false,
    replies: 32,
...
export default function ThreadList({
  ...
  const [sortBy, setSortBy] = useState<"replies" | "views" | "lastActivity">(
    "lastActivity"
  );
